...
class Translate(Resource):
    def __init__(self):
        ...
        self.reqparse.add_argument("src_text", type=str)
        self.reqparse.add_argument("src_json", type=str)
        self.reqparse.add_argument("src_lang", type=str)
        self.reqparse.add_argument("dest_lang", type=str, required=True)
        self.reqparse.add_argument("protected_text", type=str, required=True)
